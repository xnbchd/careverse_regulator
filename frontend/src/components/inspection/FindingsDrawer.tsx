          ...
          {!hasValidFindings ? (
            <Card>
              <CardContent className={cn('flex flex-col items-center justify-center', isMobile ? 'py-8' : 'py-12')}>
                <FileText className={cn('text-muted-foreground mb-4', isMobile ? 'w-10 h-10' : 'w-12 h-12')} />
                <p className={cn('text-muted-foreground text-center', isMobile ? 'text-xs' : 'text-sm')}>
