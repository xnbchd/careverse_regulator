...
export default function ProfessionalApplicationPage({
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      {/* Page heading */}
      <div className="mb-5">
        <h1 className="text-2xl font-semibold text-foreground">Professional License Application</h1>
        <p className="text-lg font-medium text-foreground mt-1">{application.fullName || "—"}</p>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <ReadOnlyField label="Country" value={application.country} icon={Globe} />
              <ReadOnlyField label="Nationality" value={application.nationality} icon={Globe} />
              <ReadOnlyField label="Phone Number" value={application.phone} icon={Phone} />
              <ReadOnlyField label="Email Address" value={application.email} icon={Mail} />
              <ReadOnlyField label="Postal Address" value={application.address} />
            </div>
          </CardContent>
        </Card>
      </div>
