...
describe('AnalyticsDashboard', () => {
  ...
  it('refresh button triggers data reload', async () => {
    ...
    const mockData = {
      loading: false,
      error: null,
      licenseStats: { total: 100, active: 80, expired: 10, expiringSoon: 5, suspended: 3, pending: 2 },
      ...
      complianceMetrics: { complianceRate: 85.0, averageProcessingTime: 10.0, pendingActions: 10, overdueInspections: 2 },
      expiryWarnings: [],
      trendData: [],
      fetchDashboardData: vi.fn(),
  ...
  it('hides inspection section when inspectionStats is null', async () => {
    ...
    const mockData = {
      ...
      complianceMetrics: { complianceRate: 0.0, averageProcessingTime: 0.0, pendingActions: 17, overdueInspections: 0 },
      expiryWarnings: [],
      trendData: [],
      fetchDashboardData: vi.fn(),
      refreshData: vi.fn()
  ...
  it('falls back to mock data after repeated API failures', async () => {
    ...
    const mockData = {
      ...
      complianceMetrics: { complianceRate: 87.5, averageProcessingTime: 12.4, pendingActions: 48, overdueInspections: 8 },
      expiryWarnings: [],
      trendData: [],
  ...
  it('renders responsive layout with all sections', async () => {
    const mockData = {
      ...
      trendData: [
        { month: 'Mar', licenses: 100, affiliations: 150, inspections: 80 }
      ],
      fetchDashboardData: vi.fn(),
      refreshData: vi.fn()
    }
