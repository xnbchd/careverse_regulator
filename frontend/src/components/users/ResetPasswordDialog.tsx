          ...
          <AlertDialogDescription asChild>
            <div className="space-y-3">
              ...
              <div className="bg-muted/50 border border-border rounded-lg p-3 space-y-1.5">
                <p className="text-sm font-medium text-foreground">The following actions will be taken:</p>
                <ul className="list-disc list-inside text-sm space-y-1 text-muted-foreground">
                  <li>Current password will be invalidated</li>
                  <li>A password reset link will be sent to <span className="font-mono text-foreground">{user?.email}</span></li>
